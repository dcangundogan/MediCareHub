...
#loginButton = CTkButton(master=frame, command=loginChecker, text="Login", fg_color="#601E88", hover_color="#E44982",
                       # font=("Arial Bold", 12), text_color="#ffffff", width=240, height=35)
#loginButton.pack(anchor="w", pady=(30, 0), padx=(30, 0))  # Bu satırı değiştirdik
# Enter tuşuna basıldığında tetiklenecek işlevi bağlayın
#frame.bind('<Return>', on_enter_pressed)
